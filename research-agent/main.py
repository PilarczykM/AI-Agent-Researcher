...
llm = ChatOpenAI(api_key=settings.openai_api_key, temperature=0.1)

workflow = Workflow(llm, firecrawl_service)
...
if __name__ == "__main__":
    # print(workflow._build_workflow().get_graph().draw_ascii())
    main()
